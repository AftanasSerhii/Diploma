...
/* for (let key in DATA_BASE_PAGES_OF_BOOKS){
    ...
    <div class="popup_content">
        ...
        <div class="popup_content-top">
            <img src="img/section-catalog/${DATA_BASE_PAGES_OF_BOOKS[key].img}" alt="">
            <div class="popup_content-top-text">
                <h1>${DATA_BASE_PAGES_OF_BOOKS[key].name}</h1>
                <h2>${DATA_BASE_PAGES_OF_BOOKS[key].autor}</h2>
                <p>Характеристики:</p>
                <ul>
                    <li>Палітурка - ${DATA_BASE_PAGES_OF_BOOKS[key].binding}</li>
                    <li>Мова - ${DATA_BASE_PAGES_OF_BOOKS[key].language}</li>
                    <li>Видавництво - ${DATA_BASE_PAGES_OF_BOOKS[key].publishingHouse}</li>
                    <li>Кількість сторінок - ${DATA_BASE_PAGES_OF_BOOKS[key].numberOfPages}</li>
                    <li>Перекладач - ${DATA_BASE_PAGES_OF_BOOKS[key].translator}</li>
                    <li>Рік видання - ${DATA_BASE_PAGES_OF_BOOKS[key].yearOfPublication}</li>
                </ul> 
            </div>
        </div>
        <div class="popup_content-passage">
            <h2>Уривок</h2>
                <p>${DATA_BASE_PAGES_OF_BOOKS[key].passage}</p>
        </div>
    </div>`
}; */

{/* <div class="section-aboutBook_top">
    <img class="section-aboutBook_top_img" src="img/section-catalog/${DATA_BASE_PAGES_OF_BOOKS[key].img}">
    <div class="section-aboutBook_top_text">
        <h1>${DATA_BASE_PAGES_OF_BOOKS[key].name}</h1>
        <h2>${DATA_BASE_PAGES_OF_BOOKS[key].autor}</h2>
        <p>Характеристики:</p>
        <ul>
    ...
    <div class="section-aboutBook_passage">
        <h2>Уривок</h2>
        <p>${DATA_BASE_PAGES_OF_BOOKS[key].passage}</p>
    </div>

    <div class="section-aboutBook_autor">
        <h2>Про автора</h2>
        <p>${DATA_BASE_PAGES_OF_BOOKS[key].aboutTheAuthor}</p>
    </div>
